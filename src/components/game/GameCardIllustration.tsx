...
// dung 1 bo mau + 1 do day net vien (var(--theme-footer), 3px) xuyen suot ca 6 game de dong bo
...
function LuckyWheel() {
  const colors = ["#FFC928", "var(--theme-primary-light)", "#FF9F1C", "var(--theme-primary)", "#FFC928", "var(--theme-primary-light)", "#FF9F1C", "var(--theme-primary)"];
  return (
    <svg viewBox="0 0 160 140" className="w-[150px] h-[128px]" aria-hidden="true">
      <ellipse cx="80" cy="120" rx="46" ry="8" fill="var(--theme-footer)" opacity="0.18" />
      <g transform="rotate(-7 80 70)">
        <circle cx="80" cy="76" r="46" fill="var(--theme-primary-dark)" stroke={STROKE} strokeWidth="3" />
...
function FishingIllustration() {
  return (
    <svg viewBox="0 0 160 140" className="w-[150px] h-[128px]" aria-hidden="true">
      <ellipse cx="78" cy="122" rx="52" ry="9" fill="var(--theme-footer)" opacity="0.15" />
      <path d="M6 100 Q40 88 78 100 T150 96 V128 H6 Z" fill="var(--theme-primary-light)" stroke={STROKE} strokeWidth="3" />
      ...
      <g transform="translate(56,86) rotate(-18)">
        <ellipse cx="14" cy="18" rx="26" ry="10" fill="var(--theme-footer)" opacity="0.12" />
        <path d="M-14 8 Q0 -18 34 -6 Q44 -2 40 10 Q30 22 8 20 Q-8 22 -14 8 Z" fill="var(--theme-primary-light)" stroke={STROKE} strokeWidth="3" />
        <path d="M-6 10 Q6 2 22 6 Q18 14 2 16 Q-4 15 -6 10 Z" fill="var(--theme-primary-soft)" />
        <path d="M34 -6 L48 -12 L46 2 Z" fill="var(--theme-primary-dark)" stroke={STROKE} strokeWidth="2.5" strokeLinejoin="round" />
...
function PuzzleIllustration() {
  ...
  return (
    <svg viewBox="0 0 160 140" className="w-[150px] h-[128px]" aria-hidden="true">
      <ellipse cx="80" cy="122" rx="52" ry="8" fill="var(--theme-footer)" opacity="0.15" />
      ...
      <g transform="translate(60,20)">
        <path d={`M0 8 h30 ${tab} h30 v70 h-60 v-30 ${tab} v-30 Z`} fill="var(--theme-primary-light)" stroke={STROKE} strokeWidth="3" />
        <path d="M4 60 Q20 48 36 58 T56 54" stroke="#fff" strokeWidth="3" fill="none" opacity="0.55" />
      </g>
      <g transform="translate(24,56)">
        <path d={`M0 8 v60 h60 v-60 ${tab} h-30 ${tab} h-30 Z`} fill="var(--theme-primary-dark)" stroke={STROKE} strokeWidth="3" />
      </g>
...
function PalmGlyph({ tint = "var(--theme-primary-dark)" }: { tint?: string }) {
  return (
    <g>
...
function MemoryMatchIllustration() {
  return (
    <svg viewBox="0 0 160 140" className="w-[150px] h-[128px]" aria-hidden="true">
      <ellipse cx="80" cy="122" rx="54" ry="8" fill="var(--theme-footer)" opacity="0.15" />
      <rect x="14" y="26" width="46" height="60" rx="10" fill="var(--theme-primary)" stroke={STROKE} strokeWidth="3" transform="rotate(-8 37 56)" />
      <rect x="98" y="30" width="46" height="60" rx="10" fill="var(--theme-primary)" stroke={STROKE} strokeWidth="3" transform="rotate(9 121 60)" />
...
function ClickCollectIllustration() {
  return (
    <svg viewBox="0 0 160 140" className="w-[150px] h-[128px]" aria-hidden="true">
      <ellipse cx="76" cy="122" rx="46" ry="8" fill="var(--theme-footer)" opacity="0.15" />
...
function DailyMissionIllustration() {
  return (
    <svg viewBox="0 0 160 140" className="w-[150px] h-[128px]" aria-hidden="true">
      <ellipse cx="82" cy="122" rx="52" ry="8" fill="var(--theme-footer)" opacity="0.15" />
      ...
      <g transform="rotate(-4 56 61)">
        <rect x="16" y="18" width="80" height="18" rx="10" fill="var(--theme-primary-light)" />
        <rect x="16" y="27" width="80" height="9" fill="var(--theme-primary-light)" />
        {[0, 1, 2].map((i) => (
          <g key={i} transform={`translate(28,${52 + i * 20})`}>
            ...
            <rect x="14" y="-3" width="44" height="6" rx="3" fill="var(--theme-primary-soft)" stroke={STROKE} strokeWidth="1" />
          </g>
        ))}
      </g>
      <g transform="translate(96,70)">
        <ellipse cx="18" cy="52" rx="26" ry="6" fill="var(--theme-footer)" opacity="0.15" />
        <rect x="0" y="16" width="44" height="34" rx="4" fill="var(--theme-primary-light)" stroke={STROKE} strokeWidth="3" />
        <rect x="0" y="16" width="44" height="10" fill="var(--theme-primary-dark)" />
...
function DefaultIllustration() {
  return (
    <svg viewBox="0 0 160 140" className="w-[150px] h-[128px]" aria-hidden="true">
      <ellipse cx="80" cy="118" rx="40" ry="8" fill="var(--theme-footer)" opacity="0.15" />
