...
export default function EndCTA() {
  return (
    <div className="mt-10 bg-brand-blue rounded-3xl p-6 sm:p-8 text-center text-white">
      <p className="font-display font-bold text-xl sm:text-2xl mb-4">Bạn muốn khám phá Phan Thiết?</p>
      <div className="flex flex-wrap items-center justify-center gap-3">
        <Link href="/luu-tru" className="bg-white text-brand-blue font-bold rounded-full px-5 py-2.5 hover:brightness-95 transition">
          Đặt tour
        </Link>
