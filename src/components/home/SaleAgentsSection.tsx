      ...
      {agents.length === 0 ? (
        ...
        <div className="flex gap-4 overflow-x-auto scrollbar-none snap-x snap-mandatory -mx-6 px-6 py-3 sm:mx-0 sm:px-0 sm:py-0 sm:grid sm:grid-cols-2 sm:overflow-visible lg:grid-cols-4 sm:gap-5">
          {agents.map((agent, i) => {
            ...
            >
              {/* photo header */}
              <Link href={`/sale/${agent.id}`} className="block relative h-24 bg-gradient-to-br from-brand-blueMid to-brand-blueLight">
              ...
              <div className="px-4 pb-4">
                ...
                <div className="flex items-center gap-1.5 mb-3">
                  ...
                  <a href={agent.fanpageUrl || "#"} className="w-7 h-7 rounded-full bg-slate-50 border border-slate-200 flex items-center justify-center text-brand-blue hover:bg-slate-100 transition-colors">
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
