    ...
    <section className="max-w-[1200px] mx-auto px-4 pb-10 sm:pb-14">
      <div className="relative bg-gradient-to-br from-brand-blue to-sky-600 rounded-3xl px-6 sm:px-10 py-10 sm:py-14 text-center overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-sky-100 mb-6 max-w-[520px] mx-auto">
            Chọn ngay chiếc xe phù hợp và gửi yêu cầu đặt thuê - chúng tôi sẽ liên hệ xác nhận trong thời gian sớm nhất.
          </p>
          <Link
            href="#danh-sach-xe"
            className="inline-flex items-center gap-2 bg-white text-brand-blue font-bold rounded-xl px-6 py-3 hover:bg-sky-50 transition"
          >
