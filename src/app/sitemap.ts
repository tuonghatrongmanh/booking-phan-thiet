...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const [foods, homestays, attractions, news, forumPosts] = await Promise.all([
  ...
  return [...staticRoutes, ...foodRoutes, ...homestayRoutes, ...attractionRoutes, ...newsRoutes, ...forumRoutes];
}
