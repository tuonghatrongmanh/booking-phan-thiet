...
import { rejectClaim } from "@/lib/booking-actions";

type Params = { params: Promise<{ id: string }> };

// POST /api/admin/stay-booking-inquiries/:id/reject-claim - admin kiểm tra ngân hàng và CHƯA thấy tiền dù khách báo đã chuyển.
...
export async function POST(_req: Request, { params }: Params) {
  ...
  const result = await rejectClaim("stay", id, { admin });
